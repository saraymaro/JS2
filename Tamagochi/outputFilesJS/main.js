...
(_a = document.getElementById("game")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", function () {
    movered("decrement");
});
...
(_b = document.getElementById("enfado")) === null || _b === void 0 ? void 0 : _b.addEventListener("click", function () {
    moveblue("decrement");
});
// barra felicidad
